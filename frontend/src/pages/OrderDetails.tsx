  ...
  return (
    <Layout>
      <div className="space-y-6">
        <header className="rounded-3xl border border-zinc-200 bg-white p-6 md:p-8">
          <p className="text-xs uppercase tracking-[0.2em] text-zinc-500">Order Summary</p>
          <h1 className="mt-2 text-3xl font-semibold text-zinc-900">Order for {order.fullName}</h1>
        ...
        <section className="rounded-3xl border border-zinc-200 bg-white p-6">
          ...
          <div className="space-y-4">
            {order.items.map((item) => (
              <div key={item.id} className="flex items-center gap-3 rounded-2xl border border-zinc-100 p-3">
